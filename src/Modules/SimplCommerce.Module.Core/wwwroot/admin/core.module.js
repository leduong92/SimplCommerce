    ...
    angular
        ...
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider.state('users', {
                ...
                .state('country-import', {
                    url: '/countries/country-import',
                    templateUrl: '_content/SimplCommerce.Module.Core/admin/countries/country-import.html',
                    controller: 'CountryImportController as vm'
                });
        }]);
})();
